...
public class Entorno {
	 ...
	 * @throws ConstructorException Cuando el tamaÒo de la matriz no es valido
	 */
	public Entorno(int n, int m) throws ConstructorException {
		if(n <= 0 || m <= 0 || (m == 1 && n == 1) || n > N_MAX || m > M_MAX ) throw new ConstructorException("Tama√±o no valido");
	 ...
	 * @throws ConstructorException Cuando el tamaÒo de la matriz no es valido o no hay coche
	 */
	...
	public Entorno(String file) throws IOException, ConstructorException{
		BufferedReader br = new BufferedReader(new FileReader(file));
		    ...
		    if(n <= 0 || m <= 0 || (m == 1 && n == 1) || n > N_MAX || m > M_MAX ) {
		    	br.close();
				throw new ConstructorException("Tama√±o no valido");
			}
		    matriz = new Miembros[n][m];
		    for(int i = 0; i < n; i++) {
		    	for(int j = 0; j < m; j++) {
	...
	/**
	 * Genera el men˙ que permite crear la matriz por consola de forma aleatoria y manual, adem·s de cambiar el porcentaje de apariciÛn de obstaculos.
	 */
	...
	/**
	 * Cambia el porcentaje de apariciÛn de obstaculos del constructor aleatorio
	 * 
	 * @param p valor del porcentaje de apariciÛn de obstaculos.
	 */
